...
const homepage = () => {
    return (
        ...
        <Services />
        <Footer /> */}
            {/* switch=rutes,comp=elemenst resoirect=navigate */}
            ...
            {/* <div className='container'>
                <div className='row'>
                    <div className='col-lg-6 col-sm-12'>
                        <div className="card cardwomen">
                            <img className="card-img-top women-cat" src={womencat} alt="Card image cap" />
                            <h1 className='text-center abc'>Women</h1>
                        </div>
                    </div>
                    <div className='col-lg-6 col-sm-12'>
                        <div className="card" style={{ width: '18rem' }}>
                            <img className="card-img-top" src={womencat} alt="Card image cap" />
                            <div className="card-body">
                            </div>
                        </div>
                    </div>
